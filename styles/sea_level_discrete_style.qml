...
<qgis styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" maxScale="0" version="3.28.2-Firenze" minScale="1e+08">
  ...
  <pipe>
    ...
    <rasterrenderer band="1" type="singlebandpseudocolor" alphaBand="-1" nodataColor="" opacity="1" classificationMax="50" classificationMin="-60">
      ...
      <rastershader>
        <colorrampshader classificationMode="1" colorRampType="DISCRETE" maximumValue="50" labelPrecision="0" clip="0" minimumValue="-60">
          <colorramp type="gradient" name="[source]">
            <Option type="Map">
              <Option value="255,255,255,255" type="QString" name="color1"/>
              <Option value="56,83,56,255" type="QString" name="color2"/>
              <Option value="ccw" type="QString" name="direction"/>
              <Option value="0" type="QString" name="discrete"/>
              <Option value="gradient" type="QString" name="rampType"/>
              <Option value="rgb" type="QString" name="spec"/>
              <Option value="0.272727;113,140,167,255;rgb;ccw:0.545455;188,210,238,255;rgb;ccw" type="QString" name="stops"/>
            </Option>
          </colorramp>
          <item value="-120" label="&lt;= -120" color="#ffffff" alpha="255"/>
          <item value="-30" label="-120 - -30" color="#718ca7" alpha="255"/>
          <item value="0" label="-30 - 0" color="#bcd2ee" alpha="255"/>
          <item value="inf" label="> 0" color="#385338" alpha="255"/>
